...
- Keep code comments and documentation in sync with the table names and structures found in the schema file.
...
- If existing code or tests reference a table absent from the schema file, correct the code to resolve the mismatch and mention the fix in the PR summary.
